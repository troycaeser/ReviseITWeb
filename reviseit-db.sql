...
-- Generation Time: Jun 16, 2013 at 02:18 PM
...
(6, 'CPC50A', 'Building & Construction', 9, '2013-05-03'),
(7, 'SIT40C', 'Hospitality', 13, '2013-05-10'),
(8, 'CLM40F', 'Interior Decoration', 18, '2013-06-03'),
(9, 'LLM22T', 'Applied Fashion Design and Technology', 21, '2013-06-01'),
(10, 'VIC22O', 'Story Writing', 27, '2013-06-02'),
(11, 'CUF50B', 'Screen and Media ', 34, '2013-06-01'),
(12, 'CUV64B', 'Image editing', 20, '2013-06-02'),
(13, 'CPC32D', 'Plumbing', 30, '2013-06-03'),
(14, 'CPC30C', 'Bricklaying ', 32, '2013-06-01'),
(15, 'BCG60B', 'Building Surveying', 33, '2013-06-02'),
(16, 'VIC22E', 'Building Design ', 37, '2013-06-03'),
(17, 'HLT41N', 'Pathology', 27, '2013-06-03'),
(18, 'FNS40E', 'Finance', 34, '2013-06-01'),
(19, 'BSB50D', 'Business Administration', 35, '2013-06-03'),
(20, 'FNS50G', 'Financial Planning', 36, '2013-06-01'),
(21, 'BSB60E', 'Marketing', 38, '2013-06-01'),
(22, 'HLT50L', 'Dental Technology', 39, '2013-06-01'),
(23, 'CHC51N', 'Youth Work', 40, '2013-06-01'),
(24, 'VIC22H', 'Justice', 42, '2013-06-03'),
(25, 'CHC41N', 'Education Support', 41, '2013-06-04'),
(26, 'CHC50M', 'Children''s Services', 47, '2013-06-04'),
(27, 'ICA40G', 'Digital Games', 48, '2013-06-03'),
(28, 'ICA40E', 'Digital Media Technologies', 50, '2013-06-03'),
(29, 'SIS40H', 'Fitness', 51, '2013-06-04'),
(30, 'SIS50J', 'Diploma of Sport ', 55, '2013-06-04'),
(31, 'AUR30L', 'Automotive Vehicle Body ', 56, '2013-06-04'),
(32, 'SIT50C', 'Event Planning', 54, '2013-06-05');
...
(5, 'While loops', 4, 'Learn how a while loop is used, what to use them for and what the syntax is when using a while loop', 'This unit covers how to use the while loop function in Java.\n\nThe syntax for it is:\nwhile (expression) \n{\n  statement(s)\n}', 5, '2013-02-11'),
...
(14, 'If Statement', 8, 'Learn the syntax for an IF statement and how to successfully use it.', 'The syntax of an if statement in PHP is identical to Java. The syntax for it goes&nbsp;<br>if (<i>condition</i>)<br>{<i><br>&nbsp; code to be executed if condition is true</i>;<i><br></i><span>}.<br><br>When coding in PHP, you need to have these tags before and at the end; &lt;?php ?&gt;.<br><br>An example of using an if statement in PHP could be:<br></span>&lt;?php<br>$t=date(\\"H\\");<br>if ($t&lt;\\"20\\")<br>{<br>&nbsp;echo \\"Have a good day!\\";<br>}<br><span>?&gt;<br></span><br>In addition to that, there is also the else statement used with an if statement. To use it, the syntax would be:<br>if (<i>condition</i>)<br>{<i><br>&nbsp; code to be executed if condition is true</i>;<i><br></i>}<br>else<br>{<i><br>&nbsp; code to be executed if condition is false</i>;<i><br></i>}<br><br>For e.g.<br>&lt;?php<br>$t=date(\\"H\\");<br>if ($t&lt;\\"20\\")<br>{<br>&nbsp;echo \\"Have a good day!\\";<br>}<br>else<br>{<br>&nbsp;echo \\"Have a good night!\\";<br>}<br>?&gt;<br>', 0, '2013-06-08'),
(15, 'Form Controls', 12, 'Learn what the different form controls are, and how they''re used', 'When creating a form in&nbsp;Visual Basic .NET, you can use multiple elements; they would be:<br><ul><li>Button</li><li>Checkbox</li><li>CheckedListBox</li><li>ComboBox</li><li>DateTimePicker</li><li>Label</li><li>LinkLabel</li><li>ListView</li><li>MaskedTextBox</li><li>MonthCalendar</li><li>NumericUpDown</li><li>RadioButton, and</li><li>TextBox</li></ul>To drag any of those icons onto a form, what you need to do is:<br><ol><li>Find the icon you wish to use</li><li>Double click the icon and it will be placed onto the form.</li></ol>', 0, '2013-06-08'),
(16, 'Coding Standard', 13, 'Learn what the coding standard is when it comes to Web Programming in general.\r\nIt varies with different programming languages', 'HTML stands for Hyper Text Markup Language.<br><br>When coding with HTML, the standard used for basic web pages is:<br>&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;h1&gt;My First Heading&lt;/h1&gt;<br><br>&lt;p&gt;My first paragraph.&lt;/p&gt;<br><br>&lt;/body&gt;<br><span>&lt;/html&gt;.<br></span><br>The DOCTYPE declaration define the document type.<br>Any text between the &lt;HTML&gt;&lt;/HTML&gt; tags are to be displayed on the web page in the browser<br>Any text between the &lt;body&gt;&lt;/body&gt; tags, displays the content on the web page<br>Any text between the &lt;H1&gt;&lt;/H1&gt; tags, is displayed as a heading<br>Any text between &lt;p&gt; and &lt;/p&gt; is displayed as a paragraph', 2, '2013-06-08'),
(17, 'Database Administration', 14, 'Learn about the different user levels when it comes to database administration. i.e. Administrator, User etc.', 'This unit covers how to perform database administration duties, e.g. making backups, creating databases etc.', 5, '2013-06-08'),
(18, 'SQLyog and SQL Server', 14, 'Learn about different programs that can be used with executing different sql commands within a database.', 'This unit will be covering what sqlyog is and how it is used to perform sql queries, the unit will also be covering what sql server is and how it is used.', 10, '2013-06-08'),
(19, 'Sprites', 15, 'Learn what sprites are and how they''re used when creating/programming video games.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed at magna eu orci laoreet rutrum. Vivamus ac venenatis nulla. Morbi arcu quam, faucibus quis blandit at, interdum eget velit. Ut congue viverra cursus. In ac sapien neque. Sed pharetra facilisis nisi, ut sollicitudin metus mollis nec. Suspendisse mollis scelerisque tortor at ullamcorper. Fusce non nisi arcu, iaculis consequat est. Maecenas eget consectetur sapien. Vivamus laoreet faucibus sodales. Aenean ultricies tempor lectus vitae aliquet.<linebreak/>\r\n\r\nDuis vitae augue est. Aliquam feugiat sem id ante tristique interdum. Nam a feugiat enim. In ac nulla sem. Nunc ultricies diam volutpat mauris feugiat a eleifend nisi pretium. Fusce eu metus in felis semper sagittis eget quis orci. Phasellus neque risus, eleifend pharetra tempor nec, vestibulum ac odio. Nunc ultrices, neque ut adipiscing vestibulum, elit purus condimentum est, ut accumsan magna leo sed sapien. Donec vitae pharetra odio.<linebreak/>\r\n\r\nVestibulum quis dignissim risus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vestibulum tempus imperdiet nibh dictum sodales. Morbi quis dui erat. Sed pulvinar feugiat orci in lobortis. Aenean sit amet dui lectus, id pharetra justo. Aliquam metus ante, ullamcorper id consequat ac, blandit ac est. Pellentesque congue placerat sapien sit amet pretium. Nunc eu ultricies enim. Nam lobortis lacus id tellus posuere dictum. Praesent ut nibh erat. Donec dolor libero, lacinia in aliquam sed, feugiat nec mauris. Nunc varius porta lacus ut aliquam. <linebreak/>', 5, '2013-06-03'),
(20, 'Sprites Animation', 16, 'Learn how to animate sprites and the limitations that can be set.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed at magna eu orci laoreet rutrum. Vivamus ac venenatis nulla. Morbi arcu quam, faucibus quis blandit at, interdum eget velit. Ut congue viverra cursus. In ac sapien neque. Sed pharetra facilisis nisi, ut sollicitudin metus mollis nec. Suspendisse mollis scelerisque tortor at ullamcorper. Fusce non nisi arcu, iaculis consequat est. Maecenas eget consectetur sapien. Vivamus laoreet faucibus sodales. Aenean ultricies tempor lectus vitae aliquet.<linebreak/>\r\n\r\nDuis vitae augue est. Aliquam feugiat sem id ante tristique interdum. Nam a feugiat enim. In ac nulla sem. Nunc ultricies diam volutpat mauris feugiat a eleifend nisi pretium. Fusce eu metus in felis semper sagittis eget quis orci. Phasellus neque risus, eleifend pharetra tempor nec, vestibulum ac odio. Nunc ultrices, neque ut adipiscing vestibulum, elit purus condimentum est, ut accumsan magna leo sed sapien. Donec vitae pharetra odio.<linebreak/>\r\n\r\nVestibulum quis dignissim risus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vestibulum tempus imperdiet nibh dictum sodales. Morbi quis dui erat. Sed pulvinar feugiat orci in lobortis. Aenean sit amet dui lectus, id pharetra justo. Aliquam metus ante, ullamcorper id consequat ac, blandit ac est. Pellentesque congue placerat sapien sit amet pretium. Nunc eu ultricies enim. Nam lobortis lacus id tellus posuere dictum. Praesent ut nibh erat. Donec dolor libero, lacinia in aliquam sed, feugiat nec mauris. Nunc varius porta lacus ut aliquam. <linebreak/>', 15, '2013-06-03'),
(21, 'Photoshop', 18, 'Learn how to use photoshop to edit images.', 'This unit covers how to use the program adobe photoshop to edit images.', 1, '2013-06-09'),
(22, 'Managing potential risks', 27, 'Learn how to possibly prevent minor/majors risks from occuring', 'This unit specifies the outcomes required to use a generic approach to identify hazards and assess and control OHS risks.<br>', 1, '2013-06-09'),
(23, 'Theory of design', 26, 'Learn the history of design and how to apply it to your own work', 'This unit describes the performance outcomes, skills and knowledge required to source information on design history and theory, and to apply that information to one''s area of work.', 0, '2013-06-09'),
(24, 'GIMP', 18, 'Learn how to use GIMP to edit images', 'This unit covers how to use the program GIMP to edit images.', 0, '2013-06-09'),
(25, 'Web Skills', 24, 'Learn some web typography skills', 'This unit covers most of the different web typography types that are used.', 0, '2013-06-09'),
(26, 'Colour', 24, 'Learn different colour typography skills', 'This unit covers how to add colour to your typography and different colour styles', 0, '2013-06-09'),
(27, 'AutoCAD', 25, 'Learn how to use the program AutoCAD.', 'This unit covers how to what the program AutoCAD is and how to use it.', 0, '2013-06-09'),
(28, 'Requirements and Processes', 21, 'Learn how to acquire requirements and use the information to process.', 'This unit specifies the outcomes required to manage risk within a project in order to avoid adverse effects on project outcomes. It covers determining, monitoring, and controlling project risks, and assessing risk management outcomes.&nbsp;', 0, '2013-06-09'),
(29, 'OHS System', 17, 'Learn how to maintain and establish an OHS system', 'This unit specifies how to main and establish an OHS system. ', 0, '2013-06-09'),
(30, 'Engagement', 19, 'Learn how to engage with the customer to be able to provide outstanding customer service.', 'This unit will be covering the engagement of customer service in the hospitality industry.', 0, '2013-06-09'),
(31, 'Providing Service', 29, 'This unit will be covering how to develop and update knowledge of food & beverage as well as providing service.', 'This unit will be covering how to provide food and beverage service, and knowledge of food and beverages.', 0, '2013-06-09'),
(32, 'Fire', 30, 'Learn what procedure to take if a fire starts occurring ', 'This unit ill be covering what procedures to take when a fire might break out.', 0, '2013-06-09'),
(33, 'Data Loss', 30, 'Learn what procedure to initiate when significant data loss has occurred.', 'This unit will be covering the procedures initialised when data loss has occurred.', 0, '2013-06-09'),
...
(40, 'AJAX and Database', 11, 'Learn how Ajax can be used to display records from a database', 'This unit covers how records from a database can be displayed from using Ajax.', 0, '2013-06-09'),
...
(42, 'Obligations', 28, 'Learn how to administer legal obligations of a building or construction contract', 'This unit covers all the legal obligations with building and construction contracts', 0, '2013-06-09'),
(43, '2D Forms', 35, 'Learn the necessary skills and knowledge with drawing 2D forms', 'This unit describes the performance outcomes, skills and knowledge required to explore and creatively apply the design process in creating 2 dimensional (2D) forms', 0, '2013-06-10'),
(44, '3D forms', 35, 'Learn the necessary skills and knowledge to draw 3D forms', 'This unit describes the performance outcomes, skills and knowledge required to explore and creatively apply the design process to the development to 3 dimensional (3D) forms', 0, '2013-06-10'),
(45, 'Calculating fabric quantites', 31, 'Learn how to calculate fabric quantities for coverings', 'This unit covers the competency to calculate fabric quantities for window coverings.<br>', 0, '2013-06-10'),
(46, 'Preparation', 36, 'Learn some ways to prepare a presentation to potential clients', 'This unit specifies the outcomes required to prepare a materials or sample board for client presentation, for interior decoration and design projects.', 0, '2013-06-10'),
(47, 'Client Input', 43, 'Learn how to refine a design brief based on the client''s input', 'This unit describes the performance outcomes, skills and knowledge required to work pro actively with a client or commissioning organisation to develop and negotiate a design brief', 0, '2013-06-10'),
(48, 'Concept design', 45, 'Learn how to take a concept design to a final realisation', 'This unit describes the performance outcomes, skills and knowledge required to manage the process of taking a design&nbsp;from concept to final realisation or production', 0, '2013-06-10'),
(49, 'Protecting IP', 44, 'Learn how to protect intellectual property from potential theft', 'This unit describes the performance outcomes, skills and knowledge required to manage intellectual protect and grow a business', 0, '2013-06-10'),
(50, 'Pipe Penetrations', 46, 'Learn how to perform pipe penetrations', 'This unit describes what pipe penetrations is and how to do it.', 0, '2013-06-10'),
(51, 'Water storage', 46, 'Learn about water storage', 'This unit describes about water storage and all possible ways to implement it ', 0, '2013-06-10'),
(52, 'Appliances', 47, 'Learn about the different household appliances that utilise gasfitting', 'This unit describes the purpose of installing gasfitting appliances into households', 0, '2013-06-10'),
(53, 'Central Heating', 48, 'Learn what central heating is and how to install it', 'This unit describes the performance outcomes, skills and knowledge required to install central heating', 0, '2013-06-10'),
(54, 'Statutory Interpretation rules', 52, 'Learn the rules of statutory interpretation in relation to building to building control legislation', 'This unit specifies the competency required to advise on building control activities in a court of law and present evidence in accordance with rules of evidence for civil and criminal trials.  It includes the identification and application of the rules of statutory interpretation as they relate to building control legislation.<br>', 0, '2013-06-10'),
(55, 'BCA', 53, 'Learn about what the BCA is and what the standards are.', 'This unit specifies the competency required to ensure the building process complies with the Building Code of Australia (BCA) and relevant Australian Standards.<br><span><br>This unit applies specifically to buildings up to three storeys and not exceeding a maximum floor area of 200m2.  It includes the evaluation and interpretation of building requirements, classification of buildings according to the Building Code of Australia criteria and identification of various strategies for compliance.</span>', 0, '2013-06-10'),
(56, 'Documentation', 61, 'Learn how to prepare documentation that will need filling out', 'This unit describes the functions involved in preparation and processing of routine financial documents, preparing journal entries, posting journals to ledgers, preparing, banking and reconciling financial receipts, and extracting a trial balance and interim reports.<br><br>This unit may apply to job roles subject to licensing, legislative, regulatory or certification requirements so the varying Commonwealth, State or Territory requirements should be confirmed with the relevant body.', 0, '2013-06-10'),
(57, 'Set up Computerised Accounting system', 62, 'Learn how to set up a computerised accounting system.', 'This unit covers the processes needed to set up a computerised account system', 0, '2013-06-10'),
(58, 'Operating computerised account systems', 62, 'Learn how to operate a computerised accounting system', 'This unit covers the processes needed for operating a computerised accounting system', 0, '2013-06-10'),
(59, 'Work relationships', 64, 'Learn how to establish work relationships and networks', 'This unit describes the performance outcomes, skills and knowledge required to develop and maintain effective work relationships and networks. <br><br>It covers the relationship building and negotiation skills required by workers within an organisation as well as freelance or contract workers.', 0, '2013-06-10'),
(60, 'Business Documents', 65, 'Learn how to design and develop business documents', 'This unit describes the performance outcomes, skills and knowledge required to design and develop business documents using complex technical features of word processing software.', 0, '2013-06-10'),
(61, 'Spreadsheets', 66, 'Learn how to create business spreadsheets', 'This unit describes the performance outcomes, skills and knowledge required to use spreadsheet software to complete business tasks and to produce complex documents.', 0, '2013-06-10'),
(62, 'Work relationships', 70, 'Learn how to establish work relationships and networks', 'This unit describes the performance outcomes, skills and knowledge required to develop and maintain effective work relationships and networks. It covers the relationship building and negotiation skills required by workers within an organisation as well as freelance or contract workers.', 0, '2013-06-10'),
(63, 'Management', 69, 'Learn how to manage the marketing process', 'This unit describes the performance outcomes, skills and knowledge required to strategically manage the marketing process and marketing personnel within an organisation.', 0, '2013-06-10'),
(64, 'Organisational Products', 68, 'Learn how to coordinate an organisation''s products', 'This unit describes the performance outcomes, skills and knowledge required to coordinate and review the promotion of an organisation''s products and services.', 0, '2013-06-10'),
(65, 'Work processes', 73, 'Learn about the workplace processes within an organisation', 'This unit describes the performance outcomes, skills and knowledge required to gather, organise and apply workplace information in the context of an organisation''s work processes.', 0, '2013-06-10'),
(66, 'Knowledge Management systems', 73, 'Learn about how management systems operate and how to use them', 'This unit describes the performance outcomes, skills and knowledge required to gather, organise and apply workplace information in the context of an organisation''s knowledge management systems.', 0, '2013-06-10'),
(67, 'Variation of tasks', 71, 'Learn about how to prepare a variety of tasks to be completed.', 'This unit describes the performance outcomes, skills and knowledge required to determine, administer and maintain resources and equipment to complete a variety of tasks.', 0, '2013-06-10'),
(68, 'Creating financial records', 72, 'Learn how to create financial records', 'This unit covers the performance outcomes, skills and knowledge required in creating financial records.', 0, '2013-06-10'),
(69, 'Monitoring client''s needs', 77, 'Learn how to monitor to the client''s needs', 'This unit describes the knowledge and skills required to identify, develop, implement, monitor and review programs to meet the needs of clients', 0, '2013-06-10'),
(70, 'Planning', 79, 'Learn how to plan what''s included in a case management document', 'This unit describes the knowledge and skills required to facilitate all aspects of case planning', 0, '2013-06-10'),
(71, 'Medical Assistance', 84, 'Learn how to provide some medical assistance when an injury has occurred ', 'This unit of competency describes the skills and knowledge required to provide first aid response, life support, management of casualty(s), the incident and other first aiders, until the arrival of medical or other assistance.', 0, '2013-06-10'),
(72, 'Java', 87, 'Learn how to do object oriented programming using Java', 'This unit covers the skills and knowledge required to perform object oriented programming with Java', 0, '2013-06-10'),
(73, 'C++', 87, 'Learn how to perform object oriented programming with C++', 'This unit covers the basic understand for object oriented programming using C++', 0, '2013-06-10'),
(74, 'Copyright', 90, 'Learn about copyright', 'This unit covers the basic principles of copyright and to avoid copyright infringement', 0, '2013-06-10'),
(75, 'Ethics', 90, 'Learn about ethics', 'This unit covers the principles of ethics', 0, '2013-06-10'),
(76, 'Privacy', 90, 'Learn about privacy', 'This unit covers the principles of privacy', 0, '2013-06-10'),
(77, 'Loose And Fitted Covers', 100, 'Learn how to fabricate and install loose and fitted covers', 'This unit covers how to fabricate and install loose and fitted covers ', 0, '2013-06-10'),
(78, 'Marine Covers', 100, 'Learn how to fabricate and install marine covers', 'This unit covers how to fabricate and install marine covers', 0, '2013-06-10'),
(79, 'Canvas Products', 100, 'Learn how to fabricate and install canvas products', 'This unit covers how to fabricate and install canvas products', 0, '2013-06-10'),
(80, 'Hammers', 20, 'Learn what you would use hammers for', 'This unit covers the usage of hammers', 0, '2013-06-10'),
(81, 'Saws', 20, 'Learn about the different types of saws that can be used', 'This unit covers the different selection of saws that are used when building and constructing.', 0, '2013-06-10'),
(82, 'Legal', 22, 'Learn about legal management', 'This unit covers specifies the skills and knowledge required for legal management', 0, '2013-06-10'),
(83, 'Risk', 22, 'Learn about risk management', 'This unit covers the skills and knowledge for risk management', 0, '2013-06-10'),
(84, 'Low rise projects', 23, 'Learn about the business codes and standards for low rise projects', 'This unit covers the business codes and standards that are applied to the construction for low rise projects', 0, '2013-06-10'),
(85, 'Mock Ups', 32, 'Learn about the use of mock ups', 'This unit covers how to create fashion mock ups for potential clients', 0, '2013-06-11'),
(86, 'Work Environment', 33, 'Learn about sustainable working environments', 'This unit covers the skills obtained for a sustainable working environment', 0, '2013-06-11'),
(87, 'Identifying standards', 34, 'Learn how to identify quality standards', 'This unit covers the skills, and knowledge to identifying and applying quality standards', 0, '2013-06-11'),
(88, 'Infringment', 37, 'Learn about copyright infringement', 'This unit covers all the possible attempts at copyright infringement that can occur', 0, '2013-06-11'),
(89, 'Teamwork', 38, 'Learn how to use team work', 'This unit covers how to use team work within an organisation', 0, '2013-06-11'),
(90, 'Designing documents', 39, 'Learn how to design business documents', 'This unit covers the skills to design business documents', 0, '2013-06-11'),
(91, 'Producing documents', 39, 'Learn how to produce business documents', 'This unit covers how the skills used for producing business documents', 0, '2013-06-11'),
(92, 'Questions', 42, 'Learn about creating questions relevant to interviewee', 'This unit covers how to create interview questions relevant to the person being interviewed', 0, '2013-06-11'),
(93, 'Ideas', 40, 'Learn how to brainstorm for programs or segments', 'This unit covers how to think of ideas for programs and segments', 0, '2013-06-11'),
(94, 'Finding Issue', 41, 'Learn how to locate a possible issue to explore on air', 'This unit covers the concept of finding an issue to report about.', 0, '2013-06-11'),
(95, 'Bullying', 41, 'Learn how to discuss bullying on air', 'This unit covers the topic of bullying and how to discuss it on programs or segments', 0, '2013-06-11'),
(96, 'Materials', 49, 'Learn what materials are to be used for reinforcement', 'This unit covers hat materials would be needed for reinforcement', 0, '2013-06-11'),
(97, 'Isolated piers', 50, 'Learn about isolated piers', 'This unit specifies the performance skills, outcomes and knowledge required to build isolated piers', 0, '2013-06-11'),
(98, 'Destruction', 51, 'Learn about demolition and how to destroy buildings', 'This unit covers the basic aspects of demolition and destruction', 0, '2013-06-11'),
(99, 'Site surveying', 54, 'Learn how to site survey', 'This unit covers the skills and knowledge needed for site surveying', 0, '2013-06-11'),
(100, 'Site Analysis', 54, 'Learn how to perform site analysis', 'This unit covers the aspects used for site analysis', 0, '2013-06-11'),
(101, 'Industry Standards', 56, 'Learn about the designing standards with the industry standards', 'This unit covers the industry standards used when designing.', 0, '2013-06-11'),
(102, 'ECG heterogeneity', 57, 'Learn what an ECG heterogeneity is and how it is used', 'This unit covers what an&nbsp;ECG heterogeneity is and how &nbsp;it is performed.', 0, '2013-06-11'),
(103, 'Recorder', 58, 'Learn how to use a recorder for an ECG', 'This unit covers how a records for an ECG is used for a patient', 0, '2013-06-11'),
(104, 'Analysing Software', 58, 'Learn how the analysis software is used to determine heart beats, rhythms etc. ', 'This unit covers how the analysis software is used to determine the heart beats, rhythms over a 24 - 48 hour period.', 0, '2013-06-11'),
(105, 'Obtain sample', 59, 'Learn how to obtain sample(s) from patients', 'This unit explains the steps taken to obtain a sample from a patient.', 0, '2013-06-11'),
(106, 'Achitectures', 55, 'Learn about administering achiectures', 'This unit covers how to manage architectures', 0, '2013-06-11'),
(107, 'Data', 60, 'Learn about obtaining the data needed to start preparing financial reports.', 'This unit covers the data that will be needed when preparing financial reports.', 0, '2013-06-11'),
(108, 'Reports', 63, 'Learn how to produce specified reports', 'This unit covers the skills and knowledge needed for when preparing reports.', 0, '2013-06-11'),
(109, 'Decisions', 67, 'Learn about how to decide when to implement superannuation', 'This unit covers the notion of deciding when to implement superannuation and how much percent each person receives.', 0, '2013-06-11'),
(110, 'Legislations', 75, 'Learn about the legislations acquired throughout the workplace', 'This unit explains the legislation for work practices.', 0, '2013-06-11'),
(111, 'Band-aid', 74, 'Learn about which injuries are in need of a band-aid.', 'This unit covers first-aid and which injuries would require the use of band-aids.', 0, '2013-06-11'),
(112, 'Anti-septic cream', 74, 'Learn about which injuries require the use of anti-septic cream', 'This unit covers the injuries that require the use anti-septic cream.', 0, '2013-06-11'),
(113, 'Children''s rights', 76, 'Learn about the children''s rights.', 'This unit covers the need for children''s rights.', 0, '2013-06-11'),
(114, 'Interviews', 80, 'Learn about interviews.', 'This unit covers the concept of interviews.', 0, '2013-06-11'),
(115, 'Litigation', 78, 'Learn to litigate legal proceedings.', 'This unit covers legal litigation.', 0, '2013-06-11'),
(116, 'Requirements', 81, 'Learn about the requirements needed for a legal and ethical framework.', 'This unit describes the knowledge and skills required to work within a legal and ethical framework that supports duty of care requirements.', 0, '2013-06-11'),
(117, 'Design care routines', 82, 'Learn ho to design care routines for children.', 'This unit covers the skills required to design care routines for children.', 0, '2013-06-11'),
(118, 'Implement care routine', 82, 'Learn how to implement a care routine.', 'This unit covers the skills and knowledge required to implement a care routine for children.', 0, '2013-06-11'),
(119, 'Monitoring', 83, 'Learn how to monitor children''s behaviour.', 'This unit covers the skills required for monitoring children''s behaviour.', 0, '2013-06-11'),
(120, 'Senses', 85, 'Learn about how to develop a children''s senses.', 'This unit covers the basis for developing children''s senses.', 0, '2013-06-11'),
(121, 'Respect', 86, 'Learn about respect.', 'This unit covers respect; whether it''s respecting someone else or yourself.', 0, '2013-06-11'),
(122, 'Levels', 88, 'Learn about the gaming principle of level design', 'This unit covers the performance skills, outcomes and knowledge required for level design.', 0, '2013-06-11'),
(123, 'Sound', 88, 'Learn about the importance of sound in a game.', 'This unit covers the performance outcomes, skills, and knowledge required for sound insertion into games.', 0, '2013-06-11'),
(124, 'Aesthetic', 89, 'Learn how to create an aesthetically pleasing Graphical User Interface.', 'This unit covers the performance outcomes, skills, and knowledge required to create an aesthetically pleasing Graphical User Interface for the gamer.', 0, '2013-06-11'),
(125, 'Level Editors', 91, 'Learn about level editors within games.', 'This unit covers the skills and knowledge of how to use level editors to create a game.', 0, '2013-06-11'),
(126, 'Macromedia Flash', 92, 'Learn about macromedia flash and how to create animations with it.', 'This unit covers the skills and knowledge required to use Macromedia Flash to create 2D and 3D animations.', 0, '2013-06-11'),
(127, 'Sponsors', 102, 'Learn about what sponsors do for events.', 'This unit covers how sponsors are used for events.', 0, '2013-06-11'),
(128, 'Budget', 104, 'Learn about how to allocate a budget for an event.', 'This unit covers the need for allocating budgets.', 0, '2013-06-11'),
(129, 'Exhibitions', 103, 'Learn about different event types.', 'This unit covers the different form of exhibitions that are displayed.', 0, '2013-06-11'),
(130, 'Agricultural', 103, 'Learn about agricultural events.', 'This unit covers the different agricultural exhibitions that are displayed.', 0, '2013-06-11'),
(131, 'Airbags', 101, 'Learn about different supplemental restraint systems.', 'This unit covers the installation and need for airbags.', 0, '2013-06-11'),
(132, 'Advice', 99, 'Learn how to provide general advice to customers.', 'This unit covers the notion of providing advice to customers relating to a query.', 0, '2013-06-11'),
(133, 'Businessmen', 96, 'Learn about different variety of stakeholders.', 'This unit covers one variety of stakeholders... Businessmen.', 0, '2013-06-11'),
(134, 'Promotions', 97, 'Learn how to pitch a promotional idea.', 'This unit covers how to implement a promotional item for a business.', 0, '2013-06-11'),
(135, 'Rehabilitation', 98, 'Learn how to provide rehab.', 'This unit covers the process of rehabilitation.', 0, '2013-06-11'),
(136, 'Fitness Test', 93, 'Learn about a variety of fitness tests.', 'This unit covers the different fitness tests.', 0, '2013-06-11'),
(137, 'Personal Training', 95, 'Learn about personal training.', 'This unit covers the basis of personal training.', 0, '2013-06-11'),
(138, 'Individual Differences', 94, 'Learn about the principle of individual differences', ' ', 0, '2013-06-11'),
(139, 'Overload', 94, 'Learn about the principle of overload.', 'This unit covers aspects of the principle of overload.', 0, '2013-06-11'),
(140, 'Progression', 94, 'Learn about the principle of progression.', 'This unit covers the aspects of the principle of progression.', 0, '2013-06-11'),
(141, 'Adaption', 94, 'Learn about the principle of adaptation.', 'This unit covers the aspects of the principle of adaptation.', 0, '2013-06-11'),
(142, 'Use/Disuse', 94, 'Learn about the principle of use/disuse.', 'This unit covers the aspects of the principle of use/disuse.', 0, '2013-06-11'),
(143, 'Specificity', 94, 'Learn about the principle of specificity.', 'This unit covers the aspects of the principle of specificity.', 0, '2013-06-11');
...
(1, 'cURL Commands', 1, 'ICT33A', 0, '2013-06-14'),
(2, 'SQL Query', 1, 'ICA50711', 0, '2013-05-17'),
(3, 'Restful Web Service', 3, 'ICT33A', 0, '2013-06-15'),
(4, 'Eclipse', 1, 'ICT33A', 0, '2013-06-09'),
(5, 'SLIM Framework', 3, 'ICT33A', 0, '2013-05-28'),
(6, 'Java', 1, 'ICT31A', 0, '2013-05-13'),
(7, 'Architecture in Housing', 6, 'CPC50210', 0, '2013-05-05'),
(8, 'PHP', 3, 'ICA50712', 0, '2013-05-16'),
(9, 'HTML5', 2, 'ICT33A', 0, '2013-05-17'),
(10, 'jQuery Mobile', 2, 'ICA40511', 0, '2013-05-17'),
(11, 'Ajax', 2, 'ICA40511', 0, '2013-05-12'),
(12, 'Visual Basic', 3, 'ICA50712', 0, '2013-05-17'),
(13, 'Web Programming', 3, 'ICA50712', 0, '2013-06-12'),
(14, 'SQL Databases', 2, 'ICA40511', 0, '2013-05-17'),
(15, 'Games Programming', 2, 'ICA40511', 0, '2013-06-04'),
(16, 'Games 2', 2, 'ICA40511', 0, '2013-06-04'),
(17, 'OH&S', 7, 'SIT40307', 0, '2013-05-17'),
(18, 'Photo Imaging', 5, 'ICA40511', 0, '2013-05-17'),
(19, 'Customer Service', 7, 'SIT40307', 0, '2013-05-20'),
(20, 'Materials', 4, 'CPC40110', 0, '2013-05-31'),
(21, 'Project Quality', 6, 'CPC50210', 0, '2013-06-09'),
(22, 'Management', 4, 'CPC40110', 0, '2013-05-31'),
(23, 'Business codes &amp; standards', 4, 'CPC40110', 0, '2013-06-10'),
(24, 'Typography Techniques', 5, 'CUV40303', 0, '2013-05-31'),
(25, 'Technical Drawings', 5, 'CUV40303', 0, '2013-06-03'),
(26, 'History of Design', 5, 'CUV40303', 0, '2013-06-09'),
(27, 'OHS Project Risk', 6, 'CPC50210', 0, '2013-06-03'),
(28, 'Administer Contract', 6, 'CPC50210', 0, '2013-05-31'),
(29, 'Food & Beverage', 7, 'SIT40307', 0, '2013-06-03'),
(30, 'Health, Safety, and Security Procedures', 7, 'SIT40307', 0, '2013-06-03'),
(31, 'Window coverings', 8, 'CLMF40408', 0, '2013-06-07'),
(32, 'Fashion design processes', 9, 'LLMT21707', 0, '2013-06-07'),
(33, 'Sustainable work practices', 9, 'LLMT21707', 0, '2013-06-07'),
(34, 'Apply quality standards', 9, 'LLMT21707', 0, '2013-06-07'),
(35, 'Creative design process to forms', 8, 'CLMF40408', 0, '2013-06-09'),
(36, 'Client presentations', 8, 'CLMF40408', 0, '2013-06-07'),
(37, 'Use and respect of copyright', 10, '22203VIC', 0, '2013-06-07'),
(38, 'Working effectively in the creative arts industry', 10, '22203VIC', 0, '2013-06-07'),
(39, 'Design and produce business documents', 10, '22203VIC', 0, '2013-06-07'),
(40, 'Produce programs &amp; segments', 11, 'CUF50107', 0, '2013-06-10'),
(41, 'Explore Issue On Air', 11, 'CUF50107', 0, '2013-06-05'),
(42, 'Conduct Interviews', 11, 'CUF50107', 0, '2013-06-07'),
(43, 'Design Briefs', 12, 'CUV60411', 0, '2013-06-07'),
(44, 'Intellectual Property', 12, 'CUV60411', 0, '2013-06-07'),
(45, 'Design realisation', 12, 'CUV60411', 0, '2013-06-07'),
(46, 'Roofing', 13, 'CPC32408', 0, '2013-06-06'),
(47, 'Gasfitting', 13, 'CPC32408', 0, '2013-06-07'),
(48, 'Mechanical Services', 13, 'CPC32408', 0, '2013-06-07'),
(49, 'Place and fix reinforcement materials', 14, 'CPC30108', 0, '2013-06-07'),
(50, 'Masonry structural systems', 14, 'CPC30108', 0, '2013-06-07'),
(51, 'Demolition', 14, 'CPC30108', 0, '2013-06-07'),
(52, 'Apply legal procedures to building surveying', 15, 'BCG60103', 0, '2013-06-07'),
(53, '3 storey building risk management principles', 15, 'BCG60103', 0, '2013-06-07'),
(54, 'Undertake site survey and analysis to inform design process', 16, '21953VIC', 0, '2013-06-07'),
(55, 'Manage architectural project administration', 16, '21953VIC', 0, '2013-06-06'),
(56, 'Comply with codes and standards in the design of commercial buildings', 16, '21953VIC', 0, '2013-06-07'),
(57, 'Electrocardiography', 17, 'HLT41812', 0, '2013-06-07'),
(58, 'Perform Holter Monitoring', 17, 'HLT41812', 0, '2013-06-07'),
(59, 'Pathology procedures', 17, 'HLT41812', 0, '2013-06-07'),
(60, 'Preparing financial reports', 18, 'FNS40611', 0, '2013-06-05'),
(61, 'Financial transactions and interim reports', 18, 'FNS40611', 0, '2013-06-07'),
(62, 'Computerised Accounting Systems', 18, 'FNS40611', 0, '2013-06-06'),
(63, 'Produce desktop published documents', 19, 'BSB50407', 0, '2013-05-30'),
(64, 'Establish networks', 19, 'BSB50407', 0, '2013-06-07'),
(65, 'Design and develop complex text documents', 19, 'BSB50407', 0, '2013-05-23'),
(66, 'Creating complex test documents', 20, 'FNS50611', 0, '2013-06-07'),
(67, 'Implementing Superannuation', 20, 'FNS50611', 0, '2013-06-07'),
(68, 'Promote products &amp; services', 21, 'BSB60507', 0, '2013-06-10'),
(69, 'Marketing Process', 21, 'BSB60507', 0, '2013-06-10'),
(70, 'Networking', 21, 'BSB60507', 0, '2013-06-06'),
(71, 'Business Resources', 22, 'HLT50512', 0, '2013-06-07'),
(72, 'Financial Records', 22, 'HLT50512', 0, '2013-06-04'),
(73, 'Workplace Information', 22, 'HLT50512', 0, '2013-06-10'),
(74, 'Advanced First Aid', 23, 'CHC51408', 0, '2013-04-03'),
(75, 'Work practices', 23, 'CHC51408', 0, '2013-04-09'),
(76, 'Rights & Safety', 23, 'CHC51408', 0, '2013-06-27'),
(77, 'Clients needs', 23, 'CHC51408', 0, '2013-06-04'),
(78, 'Crime prevention strategies', 24, '22200VIC', 0, '2013-06-06'),
(79, 'Case Management', 24, '22200VIC', 0, '2013-06-04'),
(80, 'Investigative processes', 24, '22200VIC', 0, '2013-06-04'),
(81, 'Legal and ethical framework', 25, 'CHC41712', 0, '2013-06-11'),
(82, 'Care routines', 25, 'CHC41712', 0, '2013-06-11'),
(83, 'Children behaviour', 25, 'CHC41712', 0, '2013-05-29'),
(84, 'First aid', 26, 'CHC50908', 0, '2013-06-03'),
(85, 'Children''s developmental needs', 26, 'CHC50908', 0, '2013-05-31'),
(86, 'Professional practice', 26, 'CHC50908', 0, '2013-06-01'),
(87, 'Object oriented language skills', 27, 'ICA40911', 0, '2013-05-21'),
(88, 'Game design & game playing principles', 27, 'ICA40911', 0, '2013-06-03'),
(89, 'Graphical User Interface', 27, 'ICA40911', 0, '2013-06-03'),
(90, 'Copyright, ethics & privacy', 28, 'ICA40811', 0, '2013-06-05'),
(91, 'Online learning tools', 28, 'ICA40811', 0, '2013-06-05'),
(92, '2D & 3D animation', 28, 'ICA40811', 0, '2013-06-06'),
(93, 'Client health assessment', 29, 'SIS40210', 0, '2013-04-02'),
(94, 'Exercise science principles', 29, 'SIS40210', 0, '2013-03-28'),
(95, 'Fitness orientation and screening', 29, 'SIS40210', 0, '2013-01-31'),
(96, 'Stakeholders', 30, 'SIS40210', 0, '2013-05-14'),
(97, 'Marketing opportunities', 30, 'SIS40210', 0, '2013-03-18'),
(98, 'Officials fitness and recovery programs', 30, 'SIS40210', 0, '2013-05-07'),
(99, 'Customer relations', 31, 'AUR30805', 0, '2013-06-07'),
(100, 'Fabricate and Installation', 31, 'AUR30805', 0, '2013-03-26'),
(101, 'Supplementary Restraint Systems', 31, 'AUR30805', 0, '2013-06-02'),
(102, 'On-site management services', 32, 'SIT50207', 0, '2013-04-16'),
(103, 'Event concepts', 32, 'SIT50207', 0, '2013-05-19'),
(104, 'Finance management', 32, 'SIT50207', 0, '2013-06-03'),
(105, 'Objective C', 2, 'ICT32A', 0, '2013-06-11');
