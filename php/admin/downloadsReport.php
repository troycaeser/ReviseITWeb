...
<html>
	...
	<body>
		...
		<div class="container">
		    <div class="page-header bootstro" data-bootstro-placement="bottom" data-bootstro-title="Downloads" data-bootstro-content="Welcome to the downloads report! This page shows all the contents that have been downloaded!">
			...
			<?php
				...
				echo "<div class='span12 bootstro' data-bootstro-placement='top' data-bootstro-title='List of downloads' data-bootstro-content='Displays Number of Downloads for Subtopic Content'>";
