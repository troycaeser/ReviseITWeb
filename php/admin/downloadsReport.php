...
<!-- Displays All subjects etc -->
	...
	echo "<div class='span12 bootstro' data-bootstro-placement='bottom' data-bootstro-title='List of downloads' data-bootstro-content='You may click on one of these links to go to the topics page that is associated with the selected subject.'>";
